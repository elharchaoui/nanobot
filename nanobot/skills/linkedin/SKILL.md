...
# With video (MP4; single-request upload works for files <200 MB)
python3 nanobot/skills/linkedin/scripts/api.py post "Your update text here" --video /path/to/video.mp4
```

Always confirm the post text (and media path) with the user before posting.
